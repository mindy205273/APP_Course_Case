$(document).ready(function() {
	...
	function getTaiwanWeather(city_name) {
		...
		var Your_Weather_API_key = "CWB-6E2A5642-6E37-4D06-9347-C30597228DB9";  //IMPORTANT, replace it with your weather API Authkey 中央氣象局授權碼
		//中央氣象局 F-C0032-007 一般天氣預報-全球都市天氣預報
		var url_all = "https://opendata.cwb.gov.tw/dataset/forecast/F-C0032-007?Authorization=" + Your_Weather_API_key + "&format=JSON";
	...
	function getLocationCity() {
		...
		function getPosition(position) {
			...
			var Your_LocationIQ_Token = "4833375d1c78b4";  //IMPORTANT, replace it with your LocationIQ API Token
			var settings = {
				"async": true,
				"crossDomain": true,
